...
with(dataset_1,{
  plot(dataset_1$Time,as.numeric(as.character(dataset_1$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
  plot(dataset_1$Time,as.numeric(as.character(dataset_1$Voltage)), type="l",xlab="datetime",ylab="Voltage")
  plot(dataset_1$Time,dataset_1$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
  ...
  plot(dataset_1$Time,as.numeric(as.character(dataset_1$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
